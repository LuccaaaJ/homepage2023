...
public class BoardVO extends ComDefaultVO implements Serializable{
	...
	//최종수정시점
	private java.util.Date lastUpdatPnttm;
	//최종수정자ID
	...
	public java.util.Date getLastUpdatPnttm() {
		return lastUpdatPnttm;
	}
	public void setLastUpdatPnttm(java.util.Date lastUpdatPnttm) {
		this.lastUpdatPnttm = lastUpdatPnttm;
	}
