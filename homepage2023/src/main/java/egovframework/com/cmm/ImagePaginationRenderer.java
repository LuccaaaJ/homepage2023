...
//	}
	public void initVariables(){
		firstPageLabel    = "<a href=\"{0}&amp;pageIndex= {1}\" class=\"first\" title=\"처음페이지로 이동\"><span>처음</a>";
		previousPageLabel = "<a href=\"{0}&amp;pageIndex= {1}\" class=\"prev\" title=\"이전페이지로 이동\"><span>이전</a>";
		currentPageLabel  = "<strong class=\"current\">{0}</strong>";
		otherPageLabel    = "<a href=\"{0}&amp;pageIndex= {1}\" class=\"page\" title=\"{1}페이지로 이동\"><span>{1}</a>";
