...
<script src="https://cdn.tiny.cloud/1/sdn9ktozqwrmyg159ezkgzieiaaswxj4tkh19ip2sk4pn54w/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
