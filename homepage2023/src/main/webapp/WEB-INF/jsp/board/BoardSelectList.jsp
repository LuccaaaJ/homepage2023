			...
			<div id="bbs_search">
				<form name="frm" method="post" action="/board/selectList.do">
					<fieldset>
						...
						<span class="bbtn_s"><input type="submit" value="검색" tilte="검색(수업용 게시판 게시물 내)"/></span>
					</fieldset>
				</form>
			</div>
			<%-- 목록영역--%>
				...
				<div class="bbs_list">
					...
					<c:forEach var="result" items="${noticeResultList}" varStatus="status">
							<tr class="notice">
								...
								<td class="writer" date-cell-header="작성자: "><c:out value="${result.frstRegisterId}"/></td>
								<td class="date" date-cell-header="작성일: "><fmt:formatDate value="${result.frstRegistPnttm}" pattern="yyyy-MM-dd"/></td>
